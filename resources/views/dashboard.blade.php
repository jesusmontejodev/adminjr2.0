<x-app-layout>
    ...
    <div class="view-dashboard">
        ...
        <h2 class="hero-subtitle">
            Transformamos tus tareas diarias en procesos automáticos y eficientes
        </h2>

        <span class="hero-soon">Próximamente</span>
        ...
        <h2 class="hero-subtitle">Números verificados para enviar mensajes</h2>
        ...
        <path fill="#ffffff"
            ...
            <a href="https://wa.me/529902195077" target="_blank" class="whatsapp-btn">
                Enviar mensaje
            </a>
        </div>
