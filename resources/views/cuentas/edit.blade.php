<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-black">
        <h1 class="text-2xl font-semibold text-gray-900 mb-6">Editar Cuenta</h1>
        ...
        <form action="{{ route('cuentas.update', $cuenta) }}" method="POST" class="bg-white shadow rounded-lg p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" id="descripcion"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    rows="3">{{ old('descripcion', $cuenta->descripcion) }}</textarea>
            </div>
